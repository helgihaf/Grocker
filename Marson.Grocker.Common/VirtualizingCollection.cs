...
namespace Marson.Grocker.Common
{
    ...
    public class VirtualizingCollection<T> : IList<T>, IList
    {
        ...
        private readonly long pageTimeoutMs = 10000;
        private int count = -1;
        ...
        /// <param name="pageTimeoutMs">The page timeout.</param>
        public VirtualizingCollection(IItemsProvider<T> itemsProvider, int pageSize, int pageTimeoutMs)
        {
        ...
        public long PageTimeoutMs
        {
            get { return pageTimeoutMs; }
        }
        ...
        public void CleanUpPages()
        {
            ...
            foreach (int key in keys)
            {
                ...
                if ( key != 0 && (DateTime.Now - pageTouchTimes[key]).TotalMilliseconds > PageTimeoutMs )
                {
                    pages.Remove(key);
        ...
        {
            PopulatePage(pageIndex, GetPage(pageIndex));
        }
        ...
        /// <param name="pageIndex">Index of the page.</param>
        /// <returns></returns>
        protected IList<T> GetPage(int pageIndex)
        {
            return ItemsProvider.GetRange(pageIndex*PageSize, PageSize);
        }
